...
-- The six imported tutors must also exist in core and Keycloak. Tutor sync
-- resolves these course-participation IDs to university logins through core;
-- without these rows, neither the custom tutor group nor Editor can be tested.
INSERT INTO public.student VALUES
('a1000000-0000-4000-8000-000000000001', 'Alice', 'Mueller', 'alice.mueller@example.com', '030001', 'ga01abc', true, 'female', 'DE', 'Computer Science', 'master', 3, '2025-04-01 09:00:00'),
('a1000000-0000-4000-8000-000000000002', 'Bob', 'Schmidt', 'bob.schmidt@example.com', '030002', 'ga02bcd', true, 'male', 'DE', 'Computer Science', 'master', 3, '2025-04-01 09:00:00'),
('a1000000-0000-4000-8000-000000000003', 'Clara', 'Weber', 'clara.weber@example.com', '030003', 'ga03cde', true, 'female', 'DE', 'Computer Science', 'master', 3, '2025-04-01 09:00:00'),
('a1000000-0000-4000-8000-000000000004', 'David', 'Fischer', 'david.fischer@example.com', '030004', 'ga04def', true, 'male', 'DE', 'Computer Science', 'master', 3, '2025-04-01 09:00:00'),
('a1000000-0000-4000-8000-000000000005', 'Eva', 'Braun', 'eva.braun@example.com', '030005', 'ga05efg', true, 'female', 'DE', 'Computer Science', 'master', 3, '2025-04-01 09:00:00'),
('a1000000-0000-4000-8000-000000000006', 'Felix', 'Wagner', 'felix.wagner@example.com', '030006', 'ga06fgh', true, 'male', 'DE', 'Computer Science', 'master', 3, '2025-04-01 09:00:00');

INSERT INTO public.course_participation VALUES
('a0000000-0000-0000-0000-000000000001', 'c0000001-0000-0000-0000-000000000001', 'a1000000-0000-4000-8000-000000000001'),
('a0000000-0000-0000-0000-000000000002', 'c0000001-0000-0000-0000-000000000001', 'a1000000-0000-4000-8000-000000000002'),
('a0000000-0000-0000-0000-000000000003', 'c0000001-0000-0000-0000-000000000001', 'a1000000-0000-4000-8000-000000000003'),
('a0000000-0000-0000-0000-000000000004', 'c0000001-0000-0000-0000-000000000001', 'a1000000-0000-4000-8000-000000000004'),
('a0000000-0000-0000-0000-000000000005', 'c0000001-0000-0000-0000-000000000001', 'a1000000-0000-4000-8000-000000000005'),
('a0000000-0000-0000-0000-000000000006', 'c0000001-0000-0000-0000-000000000001', 'a1000000-0000-4000-8000-000000000006');
