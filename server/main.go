...
func getDatabaseURL() string {
	...
	dbHost := utils.GetEnv("DB_HOST", utils.GetEnv("DB_HOST_INTRO_COURSE", "localhost"))
	dbPort := utils.GetEnv("DB_PORT", utils.GetEnv("DB_PORT_INTRO_COURSE", "5433"))
...
func initSentry() {
	sentryDsn := utils.GetEnv("SENTRY_DSN", utils.GetEnv("SENTRY_DSN_INTRO_COURSE", ""))
	if sentryDsn == "" {
